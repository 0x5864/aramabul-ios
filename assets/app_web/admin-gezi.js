...
(function initAdminGeziPage() {
  const listNode = document.getElementById("adminGeziList");
  const tableWrapNode = document.getElementById("adminGeziTableWrap");
  if (!listNode || !window.AramaBulAdminAuth) {
    return;
  }

  const DEFAULT_ADMIN_CITY = "İstanbul";
  /** `venues` kayıtlarını içerik mimarisindeki Gezi dikeyine göre süzer (backend `main_categories.key`) */
  const DEFAULT_MAIN_CATEGORY_KEY = "gezi";
  ...
  const listStateNode = document.getElementById("adminGeziListState");
  const totalCountNode = document.getElementById("adminGeziTotalCount");
  const formMessageNode = document.getElementById("adminGeziFormMessage");
  const formDetailsNode = document.getElementById("adminGeziFormDetails");
  const formTitleNode = document.getElementById("adminGeziFormTitle");
  const searchInput = document.getElementById("adminGeziSearchInput");
  const districtInput = document.getElementById("adminGeziDistrictInput");
  const neighborhoodInput = document.getElementById("adminGeziNeighborhoodInput");
  const categoryFilterSelect = document.getElementById("adminGeziCategoryFilter");
  const activeFilterSelect = document.getElementById("adminGeziActiveFilter");
  const photoFilterSelect = document.getElementById("adminGeziPhotoFilter");
  const sortFilterSelect = document.getElementById("adminGeziSortFilter");
  const districtDatalist = document.getElementById("adminGeziDistrictList");
  const filterNeighborhoodDatalist = document.getElementById("adminGeziFilterNeighborhoodList");
  const formNeighborhoodDatalist = document.getElementById("adminGeziNeighborhoodList");
  const searchButton = document.getElementById("adminGeziSearchButton");
  const newButton = document.getElementById("adminGeziNewButton");
  const deleteButton = document.getElementById("adminGeziDeleteButton");
  const permanentCloseButton = document.getElementById("adminGeziPermanentCloseButton");
  const syncGoogleButton = document.getElementById("adminGeziSyncGoogleButton");
  const saveAndNewButton = document.getElementById("adminGeziSaveAndNewButton");
  const paginationNode = document.getElementById("adminGeziPagination");
  const paginationCurrentNode = document.getElementById("adminGeziPaginationCurrent");
  const prevPageButton = document.getElementById("adminGeziPrevPageButton");
  const nextPageButton = document.getElementById("adminGeziNextPageButton");
  const generateMapsButton = document.getElementById("adminGeziGenerateMapsButton");
  const form = document.getElementById("adminGeziForm");
  const categorySelect = document.getElementById("adminGeziCategory");
  const tagList = document.getElementById("adminTagList");
  const photoList = document.getElementById("adminGeziPhotoList");
  const sortButtons = Array.from(document.querySelectorAll("[data-sort-key]"));
  const addPhotoButton = document.getElementById("adminGeziAddPhotoButton");
  const uploadPhotoButton = document.getElementById("adminGeziUploadPhotoButton");
  const uploadPhotoInput = document.getElementById("adminGeziPhotoUploadInput");
  const findPhotoButton = document.getElementById("adminGeziFindPhotoButton");
  const photoTemplate = document.getElementById("adminGeziPhotoItemTemplate");
  const mapsQuickLink = document.getElementById("adminGeziMapsQuickLink");
  const detailQuickLink = document.getElementById("adminGeziDetailQuickLink");
  const openDetailButton = document.getElementById("adminGeziOpenDetailButton");
  const lookupGoogleButton = document.getElementById("adminGeziLookupGoogleButton");
  const mainPhotoPreviewWrap = document.getElementById("adminGeziPhotoUriPreviewWrap");
  const mainPhotoPreviewNode = document.getElementById("adminGeziPhotoUriPreview");
  const pageLimitSelect = document.getElementById("adminGeziPageLimitSelect");

  const fields = {
    name: document.getElementById("adminGeziName"),
    slug: document.getElementById("adminGeziSlug"),
    city: document.getElementById("adminGeziCity"),
    district: document.getElementById("adminGeziDistrict"),
    neighborhood: document.getElementById("adminGeziNeighborhood"),
    categoryId: document.getElementById("adminGeziCategory"),
    cuisine: document.getElementById("adminGeziCuisine"),
    budget: document.getElementById("adminGeziBudget"),
    rating: document.getElementById("adminGeziRating"),
    userRatingCount: document.getElementById("adminGeziRatingCount"),
    latitude: document.getElementById("adminGeziLatitude"),
    longitude: document.getElementById("adminGeziLongitude"),
    address: document.getElementById("adminGeziAddress"),
    phone: document.getElementById("adminGeziPhone"),
    website: document.getElementById("adminGeziWebsite"),
    menuUrl: document.getElementById("adminGeziMenuUrl"),
    instagram: document.getElementById("adminGeziInstagram"),
    mapsUrl: document.getElementById("adminGeziMapsUrl"),
    sourcePlaceId: document.getElementById("adminGeziSourcePlaceId"),
    photoUri: document.getElementById("adminGeziPhotoUri"),
    isOpenNow: document.getElementById("adminGeziIsOpenNow"),
    openingStatusText: document.getElementById("adminGeziOpeningStatusText"),
    temporarilyClosed: document.getElementById("adminGeziTemporarilyClosed"),
    isActive: document.getElementById("adminGeziIsActive"),
    isIstanbulMvp: document.getElementById("adminGeziIsIstanbulMvp"),
    editorialSummary: document.getElementById("adminGeziSummary"),
  };
  ...
  function resetForm() {
    ...
    formTitleNode.textContent = "Yeni gezi kaydı";
    renderTagList();
    renderPhotoList();
    syncMapsQuickLink();
    syncDetailQuickLink();
  ...
  function fillForm(item) {
    ...
    formTitleNode.textContent = item.name || "Gezi kaydı";
    renderTagList();
    renderPhotoList();
    syncMapsQuickLink();
    syncDetailQuickLink();
  ...
  async function loadVenueList() {
    listStateNode.hidden = false;
    listStateNode.textContent = "Gezi kayıtları getiriliyor.";
    tableWrapNode.hidden = true;
