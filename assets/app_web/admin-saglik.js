...
(function initAdminSaglikPage() {
  const listNode = document.getElementById("adminSaglikList");
  const tableWrapNode = document.getElementById("adminSaglikTableWrap");
  if (!listNode || !window.AramaBulAdminAuth) {
    return;
  }

  const DEFAULT_ADMIN_CITY = "İstanbul";
  /** `venues` kayıtlarını içerik mimarisindeki Sağlık dikeyine göre süzer (backend `main_categories.key`) */
  const DEFAULT_MAIN_CATEGORY_KEY = "saglik";
  ...
  const listStateNode = document.getElementById("adminSaglikListState");
  const totalCountNode = document.getElementById("adminSaglikTotalCount");
  const formMessageNode = document.getElementById("adminSaglikFormMessage");
  const formDetailsNode = document.getElementById("adminSaglikFormDetails");
  const formTitleNode = document.getElementById("adminSaglikFormTitle");
  const searchInput = document.getElementById("adminSaglikSearchInput");
  const districtInput = document.getElementById("adminSaglikDistrictInput");
  const neighborhoodInput = document.getElementById("adminSaglikNeighborhoodInput");
  const categoryFilterSelect = document.getElementById("adminSaglikCategoryFilter");
  const activeFilterSelect = document.getElementById("adminSaglikActiveFilter");
  const photoFilterSelect = document.getElementById("adminSaglikPhotoFilter");
  const sortFilterSelect = document.getElementById("adminSaglikSortFilter");
  const districtDatalist = document.getElementById("adminSaglikDistrictList");
  const filterNeighborhoodDatalist = document.getElementById("adminSaglikFilterNeighborhoodList");
  const formNeighborhoodDatalist = document.getElementById("adminSaglikNeighborhoodList");
  const searchButton = document.getElementById("adminSaglikSearchButton");
  const newButton = document.getElementById("adminSaglikNewButton");
  const deleteButton = document.getElementById("adminSaglikDeleteButton");
  const permanentCloseButton = document.getElementById("adminSaglikPermanentCloseButton");
  const syncGoogleButton = document.getElementById("adminSaglikSyncGoogleButton");
  const saveAndNewButton = document.getElementById("adminSaglikSaveAndNewButton");
  const paginationNode = document.getElementById("adminSaglikPagination");
  const paginationCurrentNode = document.getElementById("adminSaglikPaginationCurrent");
  const prevPageButton = document.getElementById("adminSaglikPrevPageButton");
  const nextPageButton = document.getElementById("adminSaglikNextPageButton");
  const generateMapsButton = document.getElementById("adminSaglikGenerateMapsButton");
  const form = document.getElementById("adminSaglikForm");
  const categorySelect = document.getElementById("adminSaglikCategory");
  const tagList = document.getElementById("adminTagList");
  const photoList = document.getElementById("adminSaglikPhotoList");
  const sortButtons = Array.from(document.querySelectorAll("[data-sort-key]"));
  const addPhotoButton = document.getElementById("adminSaglikAddPhotoButton");
  const uploadPhotoButton = document.getElementById("adminSaglikUploadPhotoButton");
  const uploadPhotoInput = document.getElementById("adminSaglikPhotoUploadInput");
  const findPhotoButton = document.getElementById("adminSaglikFindPhotoButton");
  const photoTemplate = document.getElementById("adminSaglikPhotoItemTemplate");
  const mapsQuickLink = document.getElementById("adminSaglikMapsQuickLink");
  const detailQuickLink = document.getElementById("adminSaglikDetailQuickLink");
  const openDetailButton = document.getElementById("adminSaglikOpenDetailButton");
  const lookupGoogleButton = document.getElementById("adminSaglikLookupGoogleButton");
  const mainPhotoPreviewWrap = document.getElementById("adminSaglikPhotoUriPreviewWrap");
  const mainPhotoPreviewNode = document.getElementById("adminSaglikPhotoUriPreview");
  const pageLimitSelect = document.getElementById("adminSaglikPageLimitSelect");

  const fields = {
    name: document.getElementById("adminSaglikName"),
    slug: document.getElementById("adminSaglikSlug"),
    city: document.getElementById("adminSaglikCity"),
    district: document.getElementById("adminSaglikDistrict"),
    neighborhood: document.getElementById("adminSaglikNeighborhood"),
    categoryId: document.getElementById("adminSaglikCategory"),
    cuisine: document.getElementById("adminSaglikCuisine"),
    budget: document.getElementById("adminSaglikBudget"),
    rating: document.getElementById("adminSaglikRating"),
    userRatingCount: document.getElementById("adminSaglikRatingCount"),
    latitude: document.getElementById("adminSaglikLatitude"),
    longitude: document.getElementById("adminSaglikLongitude"),
    address: document.getElementById("adminSaglikAddress"),
    phone: document.getElementById("adminSaglikPhone"),
    website: document.getElementById("adminSaglikWebsite"),
    menuUrl: document.getElementById("adminSaglikMenuUrl"),
    instagram: document.getElementById("adminSaglikInstagram"),
    mapsUrl: document.getElementById("adminSaglikMapsUrl"),
    sourcePlaceId: document.getElementById("adminSaglikSourcePlaceId"),
    photoUri: document.getElementById("adminSaglikPhotoUri"),
    isOpenNow: document.getElementById("adminSaglikIsOpenNow"),
    openingStatusText: document.getElementById("adminSaglikOpeningStatusText"),
    temporarilyClosed: document.getElementById("adminSaglikTemporarilyClosed"),
    isActive: document.getElementById("adminSaglikIsActive"),
    isIstanbulMvp: document.getElementById("adminSaglikIsIstanbulMvp"),
    editorialSummary: document.getElementById("adminSaglikSummary"),
  };
  ...
  function resetForm() {
    ...
    formTitleNode.textContent = "Yeni sağlık kaydı";
    renderTagList();
    renderPhotoList();
    syncMapsQuickLink();
    syncDetailQuickLink();
  ...
  function fillForm(item) {
    ...
    formTitleNode.textContent = item.name || "Sağlık kaydı";
    renderTagList();
    renderPhotoList();
    syncMapsQuickLink();
    syncDetailQuickLink();
