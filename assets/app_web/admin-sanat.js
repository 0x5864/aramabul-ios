...
(function initAdminSanatPage() {
  const listNode = document.getElementById("adminSanatList");
  const tableWrapNode = document.getElementById("adminSanatTableWrap");
  if (!listNode || !window.AramaBulAdminAuth) {
    return;
  }

  const DEFAULT_ADMIN_CITY = "İstanbul";
  /** `venues` kayıtlarını içerik mimarisindeki Sanat dikeyine göre süzer (backend `main_categories.key`) */
  const DEFAULT_MAIN_CATEGORY_KEY = "sanat";
  ...
  const listStateNode = document.getElementById("adminSanatListState");
  const totalCountNode = document.getElementById("adminSanatTotalCount");
  const formMessageNode = document.getElementById("adminSanatFormMessage");
  const formDetailsNode = document.getElementById("adminSanatFormDetails");
  const formTitleNode = document.getElementById("adminSanatFormTitle");
  const searchInput = document.getElementById("adminSanatSearchInput");
  const districtInput = document.getElementById("adminSanatDistrictInput");
  const neighborhoodInput = document.getElementById("adminSanatNeighborhoodInput");
  const categoryFilterSelect = document.getElementById("adminSanatCategoryFilter");
  const activeFilterSelect = document.getElementById("adminSanatActiveFilter");
  const photoFilterSelect = document.getElementById("adminSanatPhotoFilter");
  const sortFilterSelect = document.getElementById("adminSanatSortFilter");
  const districtDatalist = document.getElementById("adminSanatDistrictList");
  const filterNeighborhoodDatalist = document.getElementById("adminSanatFilterNeighborhoodList");
  const formNeighborhoodDatalist = document.getElementById("adminSanatNeighborhoodList");
  const searchButton = document.getElementById("adminSanatSearchButton");
  const newButton = document.getElementById("adminSanatNewButton");
  const deleteButton = document.getElementById("adminSanatDeleteButton");
  const permanentCloseButton = document.getElementById("adminSanatPermanentCloseButton");
  const syncGoogleButton = document.getElementById("adminSanatSyncGoogleButton");
  const saveAndNewButton = document.getElementById("adminSanatSaveAndNewButton");
  const paginationNode = document.getElementById("adminSanatPagination");
  const paginationCurrentNode = document.getElementById("adminSanatPaginationCurrent");
  const prevPageButton = document.getElementById("adminSanatPrevPageButton");
  const nextPageButton = document.getElementById("adminSanatNextPageButton");
  const generateMapsButton = document.getElementById("adminSanatGenerateMapsButton");
  const form = document.getElementById("adminSanatForm");
  const categorySelect = document.getElementById("adminSanatCategory");
  const tagList = document.getElementById("adminTagList");
  const photoList = document.getElementById("adminSanatPhotoList");
  const sortButtons = Array.from(document.querySelectorAll("[data-sort-key]"));
  const addPhotoButton = document.getElementById("adminSanatAddPhotoButton");
  const uploadPhotoButton = document.getElementById("adminSanatUploadPhotoButton");
  const uploadPhotoInput = document.getElementById("adminSanatPhotoUploadInput");
  const findPhotoButton = document.getElementById("adminSanatFindPhotoButton");
  const photoTemplate = document.getElementById("adminSanatPhotoItemTemplate");
  const mapsQuickLink = document.getElementById("adminSanatMapsQuickLink");
  const detailQuickLink = document.getElementById("adminSanatDetailQuickLink");
  const openDetailButton = document.getElementById("adminSanatOpenDetailButton");
  const lookupGoogleButton = document.getElementById("adminSanatLookupGoogleButton");
  const mainPhotoPreviewWrap = document.getElementById("adminSanatPhotoUriPreviewWrap");
  const mainPhotoPreviewNode = document.getElementById("adminSanatPhotoUriPreview");
  const pageLimitSelect = document.getElementById("adminSanatPageLimitSelect");

  const fields = {
    name: document.getElementById("adminSanatName"),
    slug: document.getElementById("adminSanatSlug"),
    city: document.getElementById("adminSanatCity"),
    district: document.getElementById("adminSanatDistrict"),
    neighborhood: document.getElementById("adminSanatNeighborhood"),
    categoryId: document.getElementById("adminSanatCategory"),
    cuisine: document.getElementById("adminSanatCuisine"),
    budget: document.getElementById("adminSanatBudget"),
    rating: document.getElementById("adminSanatRating"),
    userRatingCount: document.getElementById("adminSanatRatingCount"),
    latitude: document.getElementById("adminSanatLatitude"),
    longitude: document.getElementById("adminSanatLongitude"),
    address: document.getElementById("adminSanatAddress"),
    phone: document.getElementById("adminSanatPhone"),
    website: document.getElementById("adminSanatWebsite"),
    menuUrl: document.getElementById("adminSanatMenuUrl"),
    instagram: document.getElementById("adminSanatInstagram"),
    mapsUrl: document.getElementById("adminSanatMapsUrl"),
    sourcePlaceId: document.getElementById("adminSanatSourcePlaceId"),
    photoUri: document.getElementById("adminSanatPhotoUri"),
    isOpenNow: document.getElementById("adminSanatIsOpenNow"),
    openingStatusText: document.getElementById("adminSanatOpeningStatusText"),
    temporarilyClosed: document.getElementById("adminSanatTemporarilyClosed"),
    isActive: document.getElementById("adminSanatIsActive"),
    isIstanbulMvp: document.getElementById("adminSanatIsIstanbulMvp"),
    editorialSummary: document.getElementById("adminSanatSummary"),
  };
  ...
  function resetForm() {
    ...
    formTitleNode.textContent = "Yeni sanat kaydı";
    renderTagList();
    renderPhotoList();
    syncMapsQuickLink();
    syncDetailQuickLink();
  ...
  function fillForm(item) {
    ...
    formTitleNode.textContent = item.name || "Sanat kaydı";
    renderTagList();
    renderPhotoList();
    syncMapsQuickLink();
    syncDetailQuickLink();
